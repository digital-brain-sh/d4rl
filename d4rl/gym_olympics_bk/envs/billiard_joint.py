...
class billiard_joint(OlympicsBase):
    def __init__(self, max_episode_steps=400):
        map = self.create_scenario("billiard-joint")
        self.map = map
    ...
    def reset(self):
        ...
        output_obs = [output_obs[0]['agent_obs'], output_obs[1]['agent_obs']]
        return output_obs
    ...
    def step(self, actions_list):
        ...
        energy = []
        output_obs_next = [output_obs_next[0]['agent_obs'], output_obs_next[1]['agent_obs']]
        for agent_idx in range(len(self.agent_list)):
        ...
        return output_obs_next, self.output_reward, game_done, {'energy': energy}
