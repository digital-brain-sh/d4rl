...
from .envs.billiard_joint import billiard_joint
from .envs.curling_competition import curling_competition
...
env_name_mapper = {
    ...
    'jidi-olympics-curling-expert-v0': curling_competition,
    'jidi-olympics-billiard-expert-v0': billiard_joint,
}
