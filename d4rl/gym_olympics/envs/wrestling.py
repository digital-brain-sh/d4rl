...
class wrestling(OlympicsBase):
    ...
    def _load_image(self):
        self.playground_image = pygame.image.load(os.path.join(self.current_path, "assets/wrestling/playground.png"))
        r = 440
        self.playground_image = pygame.transform.scale(self.playground_image, size = (r*0.96899, r))

        self.player_1_image = pygame.image.load(os.path.join(self.current_path, "assets/wrestling/player1.png"))
        self.player_2_image = pygame.image.load(os.path.join(self.current_path, "assets/wrestling/player2.png"))

        self.player_1_view_image = pygame.image.load(os.path.join(self.current_path, "assets/wrestling/sight1.png")).convert_alpha()
        self.player_2_view_image = pygame.image.load(os.path.join(self.current_path, "assets/wrestling/sight2.png")).convert_alpha()
