...
gen_explore_goal_locations = ['explore_goal_locations-' + str(i) for i in range(72)]

gen_explore_object_locations = ['explore_object_locations-' + str(i) for i in range(48)]

gen_explore_object_rewards = ['explore_object_rewards-' + str(i) for i in range(81)]

gen_explore_obstructed_goals = ['explore_obstructed_goals-' + str(i) for i in range(108)]

gen_lasertag = ['lasertag-' + str(i) for i in range(108)]
