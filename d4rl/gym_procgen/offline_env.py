...
class OfflineEnv(gym.Env):
    ...
    def __init__(self, game=None, ref_max_score=None, ref_min_score=None, **kwargs):
        ...
        self.ref_max_score = 1
        self.ref_min_score = 0
    ...
    def dataset_filepath(self):
        ...
        return f'/nfs/dgx08/raid/cz/procgen_dataset/{self.game}/0_0.hdf5'
        ...
        with h5py.File(h5path, 'r') as dataset_file:
            for k in tqdm(get_keys(dataset_file), desc="load datafile"):
                ...
                try:  # first try loading as an array
                    ...
                    if k == 'observations':
                        # transpose from N * 64 * 64 * 3 to N * 3 * 64 * 64
                        data_dict[k] = np.transpose(data_dict[k], (0, 3, 1, 2))
